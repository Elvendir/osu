...
namespace osu.Game.Rulesets.Osu.Difficulty.PlayerSimulator
{
    public partial class OsuDifficultyGraph : DifficultyGraph
    {
        private GraphContainer graphs = null!;
        private SettingsSlider<int> sliderMaxCombo = null!;

        private FillFlowContainer legend = null!;
        public OsuDifficultyGraph()
        {
        ...
        public override void UpdateDifficultyGraph(WorkingBeatmap workingBeatmap) => rerun();
        private void rerun()
        {
            graphs.Clear();
            legend.Clear();
